...
const CEOJuniorPolicyPage: React.FC = () => {
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="bg-white/5 rounded-2xl p-8 mb-8 border border-white/10">
          ...
          <ul className="space-y-2 text-gray-300 ml-4">
            <li className="flex items-start gap-3">
              ...
              <span>Descarga y utiliza nuestra aplicación móvil (CEO Junior), o cualquier otra aplicación nuestra que enlace a este aviso de privacidad</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 bg-brand-cyan rounded-full mt-2 flex-shrink-0" />
        ...
        <section id="section-1" className="bg-white/5 rounded-2xl p-8 mb-8 border border-white/10">
          ...
          <ul className="space-y-2 text-gray-300 ml-4 mb-6">
            ...
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 bg-brand-orange rounded-full mt-2 flex-shrink-0" />
              <span>Código familiar (E-XXXXXXXX)</span>
            </li>
          </ul>
        ...
        <section id="section-10" className="bg-white/5 rounded-2xl p-8 mb-8 border border-white/10">
          ...
          <ul className="space-y-2 text-gray-300 ml-4 mb-6">
            ...
            <li className="flex items-start gap-3">
              <span className="w-2 h-2 bg-brand-cyan rounded-full mt-2 flex-shrink-0" />
              <span><strong>Categoría B - Información personal según la Ley de Registros de Clientes de California:</strong> Nombre, información de contacto</span>
            </li>
          </ul>
        ...
        {/* Section 12 */}
        <section id="section-12" className="bg-gradient-to-br from-brand-orange/20 to-brand-yellow/20 rounded-2xl p-8 mb-8 border border-brand-orange/30">
        ...
        <section id="section-13" className="bg-white/5 rounded-2xl p-8 mb-8 border border-white/10">
          ...
          <p className="text-gray-300 leading-relaxed">
            ...
            <Link to="/ceo-junior/privacidad" className="text-brand-cyan hover:text-white transition-colors">
...
export default CEOJuniorPolicyPage;
