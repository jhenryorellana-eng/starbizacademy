...
const CEOJuniorPrivacyPage: React.FC = () => {
  return (
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="bg-white/5 rounded-2xl p-8 mb-8 border border-white/10">
          ...
          <p className="text-gray-300 leading-relaxed">
            ...
            Como usuario de CEO Junior, tienes derecho a solicitar acceso, modificación o
        ...
        <section className="bg-white/5 rounded-2xl p-8 mb-8 border border-white/10">
          ...
          <ol className="space-y-3 text-gray-300 list-decimal list-inside ml-4">
            ...
            <li>Incluye en el asunto: "Solicitud de Acceso a Datos - CEO Junior"</li>
        ...
        <section className="bg-white/5 rounded-2xl p-8 mb-8 border border-white/10">
          ...
          <ol className="space-y-3 text-gray-300 list-decimal list-inside ml-4">
            <li>Envía un correo electrónico a la dirección indicada abajo</li>
            <li>Incluye en el asunto: "Solicitud de Corrección de Datos - CEO Junior"</li>
        ...
        <section className="bg-white/5 rounded-2xl p-8 mb-8 border border-white/10">
          ...
          <ol className="space-y-3 text-gray-300 list-decimal list-inside ml-4">
            <li>Envía un correo electrónico a la dirección indicada abajo</li>
            <li>Incluye en el asunto: "Solicitud de Eliminación de Datos - CEO Junior"</li>
          ...
          <div className="mt-4 p-4 bg-red-500/10 rounded-lg border border-red-500/20">
            <p className="text-red-300 text-sm">
              ...
              Perderás todo tu progreso, logros y acceso a CEO Junior.
            </p>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-br from-brand-orange/20 to-brand-yellow/20 rounded-2xl p-8 border border-brand-orange/30">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {/* Email */}
            <a
              href="mailto:jhenry.orellana@gmail.com?subject=Solicitud%20de%20Datos%20-%20CEO%20Junior"
...
export default CEOJuniorPrivacyPage;
